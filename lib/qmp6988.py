...
class QMP6988:
    ...
    def _measure_prepare(self):
        ...
        mode = ((control[0] & _QMP6988_CONTROL_PWR_MODE_MASK)
                >> _QMP6988_CONTROL_PWR_MODE_POS)

        temp_en = ((control[0] & _QMP6988_CONTROL_TEMP_SAMPLES_MASK)
                   >> _QMP6988_CONTROL_TEMP_SAMPLES_POS) != TEMP_SAMPLES_SKIP

        press_en = ((control[0] & _QMP6988_CONTROL_PRESS_SAMPLES_MASK)
                    >> _QMP6988_CONTROL_PRESS_SAMPLES_POS) != PRESS_SAMPLES_SKIP
